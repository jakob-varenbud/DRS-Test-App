    ...
    return (
      <section className='p-4'>
        ...
        <div className='flex flex-col gap-y-1 mt-5'>
          <div className='icon-p'>Für Parkschäden, Dellen, Kratzer, Steinschläge und Innenraum</div>
          <div className='icon-p'>Kostengünstig und schnell</div>
          <div className='icon-p'>Einfach Foto schicken und zum Festpreis reparieren lassen</div>
        </div>
      </section>
    );
  }
