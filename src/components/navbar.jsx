  ...
  return (
    <nav className="relative">
      <div className='flex items-center justify-between'>
        <img className='p-2' src={DRS_Smart_Repair_Logo} alt="DRS Smart Repair Logo" />

        <div
          className={`flex flex-col justify-between gap-1 h-5 mr-4 ${menuOpen ? 'hidden' : 'flex'}`}
          onClick={toggleMenu}
        >
      ...
      <div className={`bg-drs-grey w-2/4 ${menuOpen ? 'ml-auto' : 'hidden'} absolute top-0 right-0 h-screen`}>
        {menuOpen && (
          <>
